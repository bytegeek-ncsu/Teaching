 ...
 * 
 * This example demonstrates Constructor initialiazing using initialization lists
 * 
 */
...
Person::Person(string name):name(name), age(0), gender('-'), weight(0.0){
    cout<<"------ Single Arg constructor: "<<name<<endl;
}

Person::Person(string name, int age):name(name), age(age), gender('-'), weight(0.0){
    cout<<"------ Two Arg constructor: "<<name <<", "<<age<<endl;
    
}

Person::Person(string name, int age, char sex):name(name), age(age), gender(sex), weight(0.0){
